...
export const Baba_La_Gumbala_Instructions: Song = {
  ...
  lyrics: [
    ...
    {
      lyric:
        "Three: Add fun actions like making a big pot of stone soup,chopping the ingredients,stirring pot and tasting the soup",
      person: "1",
      isInstructions: "TRUE",
      startTimeMinute: "1",
      startTimeSecond: "43",
